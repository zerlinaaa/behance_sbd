...
{{-- ─── SUB NAV (TABS) ─── --}}
<div class="subnav">
    <a href="{{ route('resources.overview') }}" class="active">Overview</a>
        ...
        <div class="cards-grid">
            ...
            <div class="job-card">
                <div class="job-card-header">
                    ...
                    <span class="job-expires">{{ $job['expires'] }}</span>
                </div>
                <h3 class="job-title">{{ $job['title'] }}</h3>
                <div class="job-price"><sup>US$</sup>{{ $job['price'] }}</div>
                <div class="job-time">
    ...
    <div class="container">
        ...
        <div class="cards-grid">
            ...
            <div class="course-card">
                ...
                <h3>{{ $course['title'] }}</h3>
                <p class="course-meta">{{ $course['parts'] }} · {{ $course['mins'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
