<?php $__env->startSection('title', 'Hiring on Behance'); ?>
...
<nav class="subnav">
    ...
    <a href="<?php echo e(route('hire.freelance')); ?>">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
            <circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35" stroke-linecap="round"/>
        </svg>
        Freelancers
    </a>
    <a href="<?php echo e(route('hire.hiring')); ?>" class="active">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
...
<section>
   ...
   <div class="category-grid">
    <?php $__currentLoopData = $catCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="cat-card" style="
        background-image: url('<?php echo e($card['img'] ?? ''); ?>');
    ...
    <div class="why-inner">
        <div class="why-content">
            ...
            <div class="why-features">
                ...
                ?>
                <?php $__currentLoopData = $whyFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="why-feature">
                    <?php if(isset($feat['pro']) && $feat['pro']): ?>
                    ...
                    <div class="why-feature-text">
                        <h4><?php echo e($feat['title']); ?></h4>
                        <p><?php echo e($feat['desc']); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="why-cta-btns">
                <a href="<?php echo e(route('explore')); ?>" class="btn-get-started">Get Started</a>
                <a href="<?php echo e(route('hire.freelance')); ?>" class="btn-browse-freelancers">Browse Freelancers</a>
            </div>
        </div>
        ...
        <div class="network-illustration">
            <div class="network-bg">
                ...
                <div class="network-avatar" style="
                    top: <?php echo e($av['top']); ?>; left: <?php echo e($av['left']); ?>;
                    width: <?php echo e($av['size']); ?>px; height: <?php echo e($av['size']); ?>px;
                    background: <?php echo e($av['color']); ?>;
                    font-size: <?php echo e(round($av['size'] * 0.3)); ?>px;
                "><?php echo e($av['init']); ?></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
...
<section class="our-freelancers-section">
    <div class="our-freelancers-header">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;">
            <div>
                ...
                <div class="fl-tabs">
                    <?php $__currentLoopData = ['All','Logo Designers','Brand Designers','Illustrators','UI/UX Designers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="fl-tab <?php echo e($loop->first ? 'active' : ''); ?>"><?php echo e($tab); ?></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
    ...
    <div class="fl-carousel" id="fl-carousel">
        ...
        <?php $__currentLoopData = $topFreelancers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="fl-card">
            <div class="fl-card-cover">
    <?php $__currentLoopData = array_slice($fl['colors'], 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="fl-cover-thumb" style="background: <?php echo e($col); ?>;"></div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div>
            <div class="fl-card-body">
                <div class="fl-avatar-wrap">
                    <div class="fl-avatar" style="background: <?php echo e($fl['color']); ?>;">
                        <?php echo e($fl['init']); ?>
                ...
                <p class="fl-card-name"><?php echo e($fl['name']); ?></p>
                <p class="fl-card-loc">
                ...
                <?php if(isset($fl['featured']) && $fl['featured']): ?>
                ...
                <?php endif; ?>
                <p class="fl-card-jobs"><?php echo e($fl['jobs']); ?> Jobs Completed</p>
                <a href="#" class="btn-hire">Hire <?php echo e(explode(' ', $fl['name'])[0]); ?></a>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<section class="how-section">
    ...
    <div class="how-steps">
        ...
        <div class="how-step <?php echo e($step['active'] ? 'active' : ''); ?>">
            <svg class="how-step-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <?php echo $step['icon']; ?>

            </svg>
            <p class="how-step-num"><?php echo e($step['num']); ?></p>
            <p class="how-step p" style="font-size:13px;color:#6e6e6e;line-height:1.5;"><?php echo e($step['desc']); ?></p>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <div class="how-screenshot">
        <div class="how-screenshot-mockup">
            <div class="mockup-sidebar">
                ...
                ?>
                <?php $__currentLoopData = $mockCandidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mockup-candidate <?php echo e($cand['active'] ? 'active' : ''); ?>">
                    <div class="mockup-cand-avatar" style="background: <?php echo e($cand['color']); ?>;"><?php echo e($cand['init']); ?></div>
                    <div>
                        <p class="mockup-cand-name"><?php echo e($cand['name']); ?></p>
                        <p class="mockup-cand-meta"><?php echo e($cand['meta']); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="mockup-main">
                <?php $thumbColors = ['#1a3a2a','#3a1a2a','#2a1a3a','#1a2a3a','#3a2a1a','#2a3a1a','#1a1a3a','#3a1a1a','#1a3a1a','#2a2a3a','#3a2a2a','#1a2a1a']; ?>
                <?php $__currentLoopData = $thumbColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mockup-thumb" style="background: <?php echo e($tc); ?>;"></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
...
<section class="testimonials-section">
    ...
    <div class="t-carousel" id="t-carousel">
        ...
        <div class="t-card">
            <p><?php echo e($t['text']); ?></p>
            <div class="t-author">
                <div class="t-avatar" style="background: <?php echo e($t['color']); ?>;"><?php echo e(strtoupper(substr($t['author'], 0, 1))); ?></div>
                <span class="t-author-name"><?php echo e($t['author']); ?></span>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <div class="t-section-cta">
        <a href="<?php echo e(route('landing')); ?>" class="btn-get-started">Get Started</a>
        <a href="<?php echo e(route('hire.freelance')); ?>" class="btn-browse-freelancers">Browse Freelancers</a>
    </div>
</section>
...
<section class="stats-section">
    ...
    <div class="stats-cta">
        <a href="<?php echo e(route('explore')); ?>" class="btn-get-started">Get Started</a>
        <a href="<?php echo e(route('hire.freelance')); ?>" class="btn-dark-outline">Browse Freelancers</a>
    </div>
</section>
...
<section class="dark-links-section">
    <div class="dark-links-grid">
        <div class="dark-links-col">
            ...
            <ul>
                <?php $designers = ['Graphic Designers','Brand Designers','UI/UX Designers','Illustrators','Logo Designers','Interaction Designers','Art Directors','Photographers','Web Designers','Industrial Designers','Architects','Motion Graphic Designers','Fashion Artists','3D Artists','Comic Artists']; ?>
        ...
        <div class="dark-links-col">
            ...
            <ul>
                <?php $services = ['Logo Design','Branding Services','Social Media Design','Website Design','Illustrations','Packaging Design','Landing Page Design','UI/UX Design','Architecture & Interior Design','Portraits','Comics & Character Design','Graphics for Streamers','Mentorship','Sound Design','Invitation Design']; ?>
                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><a href="#"><?php echo e($s); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
        <div class="dark-links-col">
            ...
            <ul>
                <?php $hiring = ['How to Hire Freelance Artists on Behance','New Way To Hire Freelancers on Behance: Book a Service','Hire Creative Talent for your Next Freelance Job from Behance','Help Center: Hiring on Behance']; ?>
                <?php $__currentLoopData = $hiring; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><a href="#"><?php echo e($h); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
        <div class="dark-links-col">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\semester2\SBD\TUBES\behance_sbd\resources\views/hire/hiring.blade.php ENDPATH**/ ?>